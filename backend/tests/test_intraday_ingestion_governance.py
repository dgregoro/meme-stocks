...
def test_run_intraday_ingestion_raises_when_lock_held() -> None:
    ...
    try:
        ...
        with patch("backend.app.services.intraday_ingestion_service.get_settings") as mock_settings:
            ...
            mock_settings.return_value.intraday_lock_heartbeat_seconds = 60
            ...
            assert "already in progress" in str(exc_info.value).lower() or "already in progress" in (exc_info.value.args[0] or "")
