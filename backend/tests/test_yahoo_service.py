...
def test_yahoo_service_returns_empty_list_when_no_data(monkeypatch) -> None:
...
def test_yahoo_service_parses_valid_history(monkeypatch) -> None:
    import yfinance as yf
...
def test_yahoo_service_raises_external_api_error_on_failure(monkeypatch) -> None:
    import yfinance as yf
